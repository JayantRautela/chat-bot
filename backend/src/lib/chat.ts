    ...
    try {
        const response = await client.chat.completions.create({
            ...
            messages: [
                {
                    role: 'system',
                    content: `You are a smart personal assistant. Your function is to generate responses based on the data you have. Only provide responses in text format in plain english. Only return the answer and not the question.
